...
PNG::PNG(PNG const& other) { _copy(other); }
...
int PNG::getWidth() const { return _width; }

int PNG::getHeight() const { return _height; }

uint8_t* PNG::buffer() { return _buffer; }
...
void PNG::_blank() { memset(_buffer, 0xFF, _width * _height * PNG::BPP); }
